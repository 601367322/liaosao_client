...
import com.xl.activity.chat.FaceAdapter;
...
@EActivity(R.layout.chat_activity_old)
public class ChatActivity extends BaseBackActivity implements
    ...
    com.xl.activity.chat.old.ChatAdapters adapter;
    ...
    protected void init() {
        ...
        adapter = new com.xl.activity.chat.old.ChatAdapters(this, new ArrayList<String>());
