...
public class DynamicListView extends ListView {
     ...
     *
     * @throws UnsupportedOperationException if the device uses an older API than 14.
     */
     ...
     *
     * @throws IllegalStateException if the adapter that was set does not extend {@code SwipeUndoAdapter}.
     */
     ...
     *
     * @throws IllegalStateException    if the drag and drop functionality is enabled
     *                                            and the adapter does not have stable ids.
     * @throws IllegalArgumentException if the drag and drop functionality is enabled
     ...
     *
     * @throws IllegalStateException if the adapter that was set does not implement {@link com.nhaarman.listviewanimations.util.Insertable}.
     */
     ...
     * @param position the position of the item in the {@link android.widget.ListAdapter}. Must be visible.
     *
     * @throws IllegalStateException if the {@link com.nhaarman.listviewanimations.itemmanipulation.swipedismiss.SwipeTouchListener}
