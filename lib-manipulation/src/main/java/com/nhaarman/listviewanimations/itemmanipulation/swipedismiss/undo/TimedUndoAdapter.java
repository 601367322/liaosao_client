...
public class TimedUndoAdapter extends SimpleSwipeUndoAdapter {
    ...
    /**
     * A {@link android.os.Handler} to post {@link com.nhaarman.listviewanimations.itemmanipulation.swipedismiss.undo.TimedUndoAdapter.TimeoutRunnable}s to.
     */
    @NonNull
    private final Handler mHandler = new Handler();

    /**
     * The {@link com.nhaarman.listviewanimations.itemmanipulation.swipedismiss.undo.TimedUndoAdapter.TimeoutRunnable}s which are posted. Keys are positions.
     */
