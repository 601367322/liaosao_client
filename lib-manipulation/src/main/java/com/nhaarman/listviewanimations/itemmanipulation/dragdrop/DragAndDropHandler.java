...
public class DragAndDropHandler implements TouchEventHandler {
    ...
    /**
     * The {@link com.nhaarman.listviewanimations.itemmanipulation.dragdrop.DragAndDropHandler.ScrollHandler} that handles scrolling when dragging an item.
     */
    @NonNull
    private final ScrollHandler mScrollHandler;

    /**
     * The {@link com.nhaarman.listviewanimations.itemmanipulation.dragdrop.DragAndDropHandler.SwitchViewAnimator} that is responsible for animating the switch views.
     */
    @NonNull
    ...
    /**
     * @throws IllegalStateException    if the adapter does not have stable ids.
     * @throws IllegalArgumentException if the adapter does not implement {@link com.nhaarman.listviewanimations.util.Swappable}.
     */
    ...
    /**
     * A {@link com.nhaarman.listviewanimations.itemmanipulation.dragdrop.DragAndDropHandler.SwitchViewAnimator} for versions KitKat and below.
    ...
    /**
     * A {@link com.nhaarman.listviewanimations.itemmanipulation.dragdrop.DragAndDropHandler.SwitchViewAnimator} for versions L and above.
