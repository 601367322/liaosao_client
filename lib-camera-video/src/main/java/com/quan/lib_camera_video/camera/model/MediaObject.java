package com.quan.lib_camera_video.camera.model;
...
public class MediaObject implements Serializable {
	...
	public String getOutputTempVideoPath1() {
		return mOutputDirectory + File.separator + mKey + "_s.mp4";
	}
	...
	public String getOutputVideoPath() {
		return mOutputDirectory + File.separator + (mKey + ".mp4").hashCode();
	}

	/** 获取视频截图临时输出地址 */
	public String getOutputTempVideoThumbPath() {
		return mOutputDirectory + File.separator + mKey + ".jpg";
	}

	/** 获取视频截图最终输出地址 */
	public String getOutputVideoThumbPath() {
		return mOutputDirectory + File.separator + (mKey + ".jpg").hashCode();
	}
